...
def plot_all_sensitivities(fsr: FisherResults, outdir=Path(".")):
    """Plots results of the sensitivities :math:`s_{ij} = \frac{\partial y_i}{\partial p_j}` with time points at which the ODE is evaluated
    for every input combination.
...
def plot_all_solutions(fsr: FisherResults, outdir=Path(".")):
    """Combines functionality of plot_all_odes and plot_all_sensitivities.
    Plots results of the ODE with time points at which the ODE is evaluated
